...
ActiveRecord::Schema.define(version: 2021_08_06_063615) do
  ...
  create_table "target_scores", force: :cascade do |t|
    t.integer "math"
    t.integer "english"
    t.integer "science"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["student_id"], name: "index_target_scores_on_student_id"
  end
  ...
  add_foreign_key "target_scores", "students"
end
